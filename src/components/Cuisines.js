...
const images = [
    { id: 1, imagePath: Pasta, label: 'Italian Pasta', price: '$99.99' },
    { id: 2, imagePath: Pizza, label: 'Cheese Pizza', price: '$199.99' },
            ...
            <div className='dishes-aligner'>
                {images.map(e => (
                    <div className="card" key={e.id}>
                        ...
                        <div className="container" style={{ backgroundColor: theme === "light" ? "#edefee" : "wheat" }}>
                            ...
                            <button type='button' className='online-menu'>Order a Delivery &nbsp;<i className="fa fa-arrow-right"></i></button>
                        </div>
                    </div>
                ))}
            </div>
